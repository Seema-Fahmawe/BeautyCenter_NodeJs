...
router.put('/updateReservation/:reservationId', auth(endPoint.updateReservation),
    validation(validators.updateReservation), reservationController.updateReservation);
